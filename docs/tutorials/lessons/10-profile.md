...
> هدف الدرس: فهم صفحة الملف الشخصي في صوري — رفع الصورة الشخصية (من الجهاز أو الكاميرا؛ الخادم يتحقق من **Magic Bytes**)، تعديل الاسم والبريد، تغيير كلمة المرور، وحذف الحساب مع تأكيد كلمة المرور، وربطها بـ [JWT والجلسة](../concepts-guide.md) — القسم 5.
